...
<head>
    ...
    <script type="text/javascript">
	    $(document).ready(function() {
			$('#phongHoc').autocomplete({
				source: '${pageContext.request.contextPath}/admin/searchAuto-phong-hoc'
			});
		});
    </script>
</head>
        ...
        <div class="row ">
            <div class="col-sm-2 ">
                <div class="vertical-menu ">
                    ...
                    <a href="phong-hoc" class="active"><i class="fas fa-building"></i> Phòng Học</a>
            ...
            <div class="col-sm-10 ">
            	...
            	<nav class="navbar navbar-expand-lg">
                	<ul class="navbar-nav mr-auto">
                		<li>
	                   		<form class="form-inline my-2 my-lg-0" method="get" action="phong-hoc" role="search">
	                       		<input id="phongHoc" name="k" class="form-control mr-sm-2" type="search" placeholder="Tìm kiếm phòng học" aria-label="Search">
                   	...
                   	<ul class="navbar-nav">
                   		<li>   
                   			<c:url value="add-phong-hoc" var="addLink">
	                    ...
	                    <c:when test="${!empty pagedListHolder.pageList}">
	                    	...
	                    	<thead class="thead-bg ">
		                        <tr>
		                            ...
		                            <th scope="col">Loại Phòng Học</th>
		                            <th scope="col">Thao Tác</th>
		                        </tr>
		                    </thead>
		                    <tbody>
		                    	<c:forEach end="${result}" items="${pagedListHolder.pageList}" var="phongHoc" varStatus="loop">
		                    		<c:url var="updateLink" value="edit-phong-hoc">
		                    			<c:param name="maPH" value="${phongHoc.maPH}"></c:param>
		                    			<c:param name="p" value="${pagedListHolder.page}"></c:param>
		                    			<c:if test="${search}">
		                   					<c:param name="k" value="${k}"></c:param>
		                   				</c:if>
		                    		</c:url>		                    		
		                    		<c:url var="deleteLink" value="delete-phong-hoc">
		                    			<c:param name="maPH" value="${phongHoc.maPH}"></c:param>
		                    			<c:param name="p" value="${pagedListHolder.page}"></c:param>
		                    			<c:if test="${search}">
		                   					<c:param name="k" value="${k}"></c:param>
